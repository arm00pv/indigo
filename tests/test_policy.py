...
class TestPolicyEngine:
    ...
    def test_ip_blacklist(self, client):
        # 1. Block Localhost
        resp = client.post('/admin/policy/blacklist', json={"cidr": "127.0.0.1/32", "reason": "Test Block"})
        ...
        # 4. Unblock
        client.delete('/admin/policy/blacklist', json={"cidr": "127.0.0.1/32"})
    ...
    def test_business_hours(self, client):
        # 1. Enable Biz Hours
        client.post('/admin/settings', json={"business_hours_enabled": True})
